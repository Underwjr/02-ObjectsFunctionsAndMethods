...
def main():
    ...
    #better_draw_circles(rg.Point(100,100), 119)
    even_better_draw_circles(rg.Point(10,10), 15, 20, 'indigo', 12)
    window.update()
...
def even_better_draw_circles(point, radiiincrease, number, color, thick):
    ...
    for k in range(1, number):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(radiiincrease * k)
